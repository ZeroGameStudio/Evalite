...
StaticLibraryContext constantContext = new(typeof(Constants));
CompositeContext context = new(mathContext, constantContext);
...
do
{
	...
	if (!string.IsNullOrWhiteSpace(cmd))
	{
		try
		{
			var result = compiler.Compile<object>(cmd, context)();
